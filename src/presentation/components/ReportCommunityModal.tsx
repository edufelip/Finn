...
export default function ReportCommunityModal({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error('ReportCommunityModal submission error:', error);
    } finally {
      setSubmitting(false);
    }
  };
        ...
        <Pressable style={styles.backdrop} onPress={handleClose}>
          <Pressable style={styles.modal} onPress={(e) => e.stopPropagation()}>
            <View style={styles.header}>
              <Text style={styles.title}>{t('community.report.modal.title')}</Text>
              <Pressable onPress={handleClose} disabled={submitting} testID="community-report-modal-close">
                <MaterialIcons name="close" size={24} color={theme.onSurface} />
              </Pressable>
            </View>

            <Text style={styles.description}>{t('community.report.modal.description')}</Text>
            ...
            <View style={styles.inputContainer}>
              <TextInput
                ...
                editable={!submitting}
                testID="community-report-modal-input"
              />
            ...
            <Pressable
              ...
              testID="community-report-modal-submit"
            >
              {submitting ? (
                ...
                <>
                  ...
                  >
                    {t('community.report.modal.submit')}
                  </Text>
                </>
              )}
            </Pressable>
